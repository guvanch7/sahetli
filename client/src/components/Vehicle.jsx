            ...
            <MDBContainer className='mt-5'>
                <MDBRow>
                    ...
                    <MDBCol lg={6}>
                        ...
                        <p>Мы обеспечиваем клиентов техникой, соответствующей специфике их проектов —  земляные работы, монтажные операции, перемещение грузов или другие технологически сложные процессы. Благодаря налаженным партнёрским связям, мы предлагаем надёжные и своевременные решения для любых производственных потребностей.</p>
                        <p>Также наша компания предлагает транспортные услуги любой сложности – от индивидуальных поездок до масштабных групповых перевозок. Мы подберем транспорт под любые задачи и количество пассажиров.
