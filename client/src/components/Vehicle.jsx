            ...
            <MDBContainer className='mt-5'>
                <MDBRow>
                    ...
                    <MDBCol lg={6}>
                        ...
                        <p>Также наша компания предлагает транспортные услуги любой сложности – от индивидуальных поездок до масштабных групповых перевозок. Мы подберем транспорт под любые задачи и количество пассажиров.</p>
