...
function Vehicle() {
    ...
    return (
        <>
            <MDBContainer className='mt-5' id="vehicleService">
                <MDBRow>
                    ...
                    <MDBCol lg={6}>
                        ...
                        <p>Наша компания предоставляет специлизированную технику для выполнения широкого спектра задач в строительной, промышленной, нефтяной и энергетической отраслях</p>
                        <p>Мы предлагаем в аренду современную спецтехнику для выполнения любых задач - от земляных работ до строительства и логистики. </p>
                        <p> Также наша компания предлагает транспортные услуги любой сложности – от индивидуальных до масштабных групповых перевозок.  Мы подберем транспорт под любые задачи и количество пассажиров. </p>
