                ...
                <MDBContainer>
                    <MDBRow>
                        ...
                        <MDBCol lg={6}>
                            ...
                            <h2 className='text-black fw-bolder'>Почему клиенты выбирают <br />  <span className='logo-color'> Sahetli Hyzmat?</span></h2>
                ...
                <MDBRow>
                    ...
                    <MDBCol lg={6}>
                        ...
                        <MDBRow className='justify-content-center  '>
                            <MDBCol className="bg-light mx-3 p-3 my-1  shadow-5 rounded-8" lg={4}>
                                <p>на рынке</p>
                                <h2 className='fw-bolder logo-txt-color display-6'>+{productiveWork} лет</h2>
                            </MDBCol>
                            <MDBCol className="bg-light  mx-3 p-3 my-1   rounded shadow-5" lg={4}>
                                <p>  специалистов</p>
                                <h3 className='fw-bolder logo-txt-color display-6'>{employees}+</h3>
                            </MDBCol>
                            <MDBCol className="bg-light  mx-3 p-3 my-4  shadow-5 rounded" lg={4}>
